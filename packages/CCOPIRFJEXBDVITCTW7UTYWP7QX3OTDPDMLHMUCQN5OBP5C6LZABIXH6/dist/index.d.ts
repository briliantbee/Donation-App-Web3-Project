...
export declare const networks: {
    readonly testnet: {
        ...
        readonly contractId: "CCOPIRFJEXBDVITCTW7UTYWP7QX3OTDPDMLHMUCQN5OBP5C6LZABIXH6";
    };
};
...
export interface Client {
     ...
     */
    create_campaign: ({ admin, title, description, category, target_amount, recipient }: {
        admin: string;
        title: string;
        description: string;
        category: CampaignCategory;
     ...
     */
    donate: ({ donor, campaign_id, amount, is_anonymous }: {
        donor: string;
        campaign_id: u32;
        amount: i128;
        is_anonymous: boolean;
     ...
     */
    get_campaign_donations: ({ campaign_id }: {
        campaign_id: u32;
    }, options?: {
        /**
         * The fee to pay for the transaction. Default: BASE_FEE
     ...
     */
    close_campaign: ({ admin, campaign_id }: {
        admin: string;
        campaign_id: u32;
    }, options?: {
        /**
     ...
     */
    withdraw: ({ recipient, campaign_id }: {
        recipient: string;
        campaign_id: u32;
    }, options?: {
        /**
...
export declare class Client extends ContractClient {
    ...
    readonly fromJSON: {
        ...
        get_campaign_donations: (json: string) => AssembledTransaction<Donation[]>;
        get_all_donations: (json: string) => AssembledTransaction<Donation[]>;
        close_campaign: (json: string) => AssembledTransaction<null>;
        get_total_donations: (json: string) => AssembledTransaction<bigint>;
