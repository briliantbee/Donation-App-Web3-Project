...
export interface Client {
   ...
   */
  initialize: ({recipient}: {recipient: string}, options?: {
    /**
   ...
   */
  withdraw: ({recipient}: {recipient: string}, options?: {
    /**
     * The fee to pay for the transaction. Default: BASE_FEE
     */
    fee?: number;
...
export class Client extends ContractClient {
  ...
  constructor(public readonly options: ContractClientOptions) {
    super(
      new ContractSpec([ "AAAAAQAAAAAAAAAAAAAACERvbmF0aW9uAAAAAwAAAAAAAAAGYW1vdW50AAAAAAALAAAAAAAAAAVkb25vcgAAAAAAABMAAAAAAAAACXRpbWVzdGFtcAAAAAAAAAY=",
        ...
        "AAAAAAAAAAAAAAAId2l0aGRyYXcAAAABAAAAAAAAAAlyZWNpcGllbnQAAAAAAAATAAAAAQAAAAs=" ]),
      options
    )
  }
  public readonly fromJSON = {
    initialize: this.txFromJSON<null>,
        ...
        get_recipient: this.txFromJSON<string>,
