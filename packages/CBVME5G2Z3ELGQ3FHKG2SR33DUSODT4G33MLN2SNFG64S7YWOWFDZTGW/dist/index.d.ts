...
export declare const networks: {
    readonly testnet: {
        ...
        readonly contractId: "CBVME5G2Z3ELGQ3FHKG2SR33DUSODT4G33MLN2SNFG64S7YWOWFDZTGW";
    };
};
...
export declare class Client extends ContractClient {
    ...
    readonly fromJSON: {
        ...
        get_recipient: (json: string) => AssembledTransaction<string>;
