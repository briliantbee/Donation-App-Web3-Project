...
export declare const networks: {
    readonly testnet: {
        ...
        readonly contractId: "CCGVX23GQ6NQWWNGAL5CC64VLTVAVHY5LLJTERU6KRGKCZOQHKZK3J5S";
    };
};
...
export interface Client {
     ...
     */
    create_campaign: ({ title, description, category, target_amount, recipient }: {
        title: string;
        description: string;
        category: string;
        target_amount: i128;
...
export declare class Client extends ContractClient {
    ...
    readonly fromJSON: {
        ...
        get_donations: (json: string) => AssembledTransaction<Donation[]>;
